...
import bg from '@/assets/images/cover-bg.jpg'
      ...
      items-center min-h-screen"
          ...
          <div className="flex flex-col lg:flex-row lg:-mx-8">
            <div className="w-full lg:w-1/2 lg:px-8">
              ...
              <p className="mt-2 leading-relaxed">
                Donec convallis sollicitudin facilisis. Integer nisl ligula, accumsan non tincidunt
                ac, imperdiet in enim. Donec efficitur ullamcorper metus, eu venenatis nunc. Nam
            ...
            <div className="w-full lg:w-1/2 lg:px-8 mt-12 lg:mt-0">
              ...
              <div className="md:flex mt-8">
                ...
                <div className="md:ml-8 mt-4 md:mt-0">
                  ...
                  <p className="mt-2 leading-relaxed">
                    Your treatment plan will perfectly match your needs, lifestyle, and goals. Even
                    if it’s been years since you last visited the dentist, we can help. Our
          ...
          <div className="md:flex md:flex-wrap mt-24 text-center md:-mx-4">
            <div className="md:w-1/2 md:px-4 lg:w-1/4">
              <div className="bg-white rounded-lg border border-gray-300 p-8">
                <Image src="../assets/images/teeth-whitening.svg" alt="" className="h-20 mx-auto" />
            ...
            <div className="md:w-1/2 md:px-4 mt-4 md:mt-0 lg:w-1/4">
              <div className="bg-white rounded-lg border border-gray-300 p-8">
                <Image src="../assets/images/oral-surgery.svg" alt="" className="h-20 mx-auto" />
            ...
            <div className="md:w-1/2 md:px-4 mt-4 md:mt-8 lg:mt-0 lg:w-1/4">
              <div className="bg-white rounded-lg border border-gray-300 p-8">
                <Image
                  src="../assets/images/painless-dentistry.svg"
                  alt=""
            ...
            <div className="md:w-1/2 md:px-4 mt-4 md:mt-8 lg:mt-0 lg:w-1/4">
              <div className="bg-white rounded-lg border border-gray-300 p-8">
                <Image src="../assets/images/periodontics.svg" alt="" className="h-20 mx-auto" />
        ...
        <section className="relative bg-white px-4 sm:px-8 lg:px-16 xl:px-40 2xl:px-64 py-32">
          <div className="">
            ...
            <a href="#" title="" className="inline-block text-teal-500 font-semibold mt-6 mt:md-0">
              View All Posts
            </a>
          </div>
                  ...
                  <div className="flex items-center mt-4">
                    ...
                    <div className="ml-4">
                      <p className="text-gray-600">
                        By <span className="text-gray-900 font-semibold">Abby Sims</span>
                      </p>
                    </div>
                  </div>
                </div>
